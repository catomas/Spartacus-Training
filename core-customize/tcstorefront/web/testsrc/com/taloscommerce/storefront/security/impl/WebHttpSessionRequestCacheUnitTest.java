...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcstorefront/electronics/en",
						"https://electronics.local:9002/tcstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcstorefront/electronics/en",
						"https://electronics.local:9002/tcstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tcstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcstorefront/electronics/en",
						"https://electronics.local:9002/tcstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcstorefront",
						"https://electronics.local:9002/tcstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcstorefront",
						"https://electronics.local:9002/tcstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcstorefront/electronics/en",
						"https://electronics.local:9002/tcstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

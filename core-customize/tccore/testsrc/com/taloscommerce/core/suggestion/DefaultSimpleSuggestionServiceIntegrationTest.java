 ...
 */
package com.taloscommerce.core.suggestion;
...
import com.taloscommerce.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/tccore/test/testSimpleSuggestionService.csv", "utf-8");
	}

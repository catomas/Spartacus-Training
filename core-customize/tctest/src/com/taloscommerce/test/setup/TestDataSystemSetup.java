 ...
 */
package com.taloscommerce.test.setup;
...
import com.taloscommerce.test.constants.TcTestConstants;
import com.taloscommerce.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TcTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tctest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/tctest/import/cstickets.impex");
			...
			importImpexFile(context, "/tctest/import/csquotes.impex");
		}
	}
}

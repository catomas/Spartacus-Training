 ...
 */
package com.taloscommerce.webservices.v2.config;
...
import com.taloscommerce.webservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "tccommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "tccommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "tccommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "tccommercewebservices.v2.description";
	private static final String TITLE = "tccommercewebservices.v2.title";
	private static final String VERSION = "tccommercewebservices.v2.version";
	private static final String LICENSE = "tccommercewebservices.v2.license";
	private static final String LICENSE_URL = "tccommercewebservices.v2.license.url";

 ...
 */
package com.taloscommerce.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TcFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TcFulfilmentProcessConstants.PARENT_PROCESS);
